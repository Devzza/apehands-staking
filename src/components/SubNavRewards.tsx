    ...
    return (
        <div  className="text-center font-lexend">
            ...
            {!isTokenBalanceLoading && (
                <>
                <div className="drop-shadow-[0_20px_50px_rgba(255,_239,_15,_0.7)] gap-4 pb-4 w-full h-24 bg-no-repeat bg-contain bg-center flex items-center justify-items-center justify-center "
                style={{backgroundImage:"url('/divbalance.svg", width:"auto" }}>
